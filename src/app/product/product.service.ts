...
export class ProductService {
  products: Product[] = [
    ...
    new Product('P3', 'Xiaomi 11T Pro', 'Phone', 'https://cdn.tgdd.vn/Products/Images/42/248218/xiaomi-11t-pro-blue-1-600x600.jpg', 14990000),
    ...
    new Product('SW1', 'Apple Watch S6 40mm', 'SmartWatch', 'https://cdn.tgdd.vn/Products/Images/7077/229044/Slider/apple-watch-s6-40mm-vien-nhom-day-cao-su-221020-1219320.jpg', 11990000),
    new Product('SW2', 'Garmin Venu 2', 'SmartWatch', 'https://cdn.tgdd.vn/Products/Images/7077/241947/Slider/vi-vn-venu-2-day-silicone-xanh-fix-(1).jpg', 9990000),
    new Product('SW3', 'Samsung Galaxy Watch 4', 'SmartWatch', 'https://cdn.tgdd.vn/Products/Images/7077/248761/Slider/vi-vn-samsung-galaxy-watch-4-classic-46mm-12-fix1.jpg', 8990000),
  ]
  ...
  getCellphones(){
    return this.products.filter(x => x.category === 'Phone')
  }

  getLaptops(){
    return this.products.filter(x => x.category === 'Laptop')
  }

  getTablets(){
    return this.products.filter(x => x.category === 'Tablet')
  }

  getSmartWatches(){
    return this.products.filter(x => x.category === 'SmartWatch')
  }
